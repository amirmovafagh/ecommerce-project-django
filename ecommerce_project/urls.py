...
urlpatterns = [
                  ...
                  path('category/<int:id>/<slug:slug>/', views.CategoryProductsList.as_view(), name='category_products'),
                  path('category/<int:id>/<slug:slug>/<int:page>', views.CategoryProductsList.as_view(), name='category_products'),
