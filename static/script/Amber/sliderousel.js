...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/cell", ["get-size/get-size"], function(i) { return e(t, i) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("get-size")) : (t.sliderousel = t.sliderousel || {}, t.sliderousel.Cell = e(t, t.getSize)) }(window, function(t, e) {
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/slide", e) : "object" == typeof module && module.exports ? module.exports = e() : (t.sliderousel = t.sliderousel || {}, t.sliderousel.Slide = e()) }(window, function() {
    "use strict";
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/animate", ["fizzy-ui-utils/utils"], function(i) { return e(t, i) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("fizzy-ui-utils")) : (t.sliderousel = t.sliderousel || {}, t.sliderousel.animatePrototype = e(t, t.fizzyUIUtils)) }(window, function(t, e) {
...
function(t, e) {
    if ("function" == typeof define && define.amd) define("sliderousel/js/sliderousel", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function(i, n, s, o, r, a) { return e(t, i, n, s, o, r, a) });
    else if ("object" == typeof module && module.exports) module.exports = e(t, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate"));
    else {
        var i = t.sliderousel;
        t.sliderousel = e(t, t.EvEmitter, t.getSize, t.fizzyUIUtils, i.Cell, i.Slide, i.animatePrototype)
    }
}(window, function(t, e, i, n, s, o, r) {
    function a(t, e) { for (t = n.makeArray(t); t.length;) e.appendChild(t.shift()) }

    function h(t, e) { var i = n.getQueryElement(t); if (!i) return void(d && d.error("Bad element for sliderousel: " + (i || t))); if (this.element = i, this.element.sliderouselGUID) { var s = f[this.element.sliderouselGUID]; return s.option(e), s } l && (this.$element = l(this.element)), this.options = n.extend({}, this.constructor.defaults), this.option(e), this._create() }
    var l = t.jQuery,
    ...
    n.extend(p, e.prototype), p._create = function() {
        var e = this.guid = ++u;
        this.element.sliderouselGUID = e, f[e] = this, this.selectedIndex = 0, this.restingFrames = 0, this.x = 0, this.velocity = 0, this.originSide = this.options.rightToLeft ? "right" : "left", this.viewport = document.createElement("div"), this.viewport.className = "sliderousel-viewport", this._createSlider(), (this.options.resize || this.options.watchCSS) && t.addEventListener("resize", this), h.createMethods.forEach(function(t) { this[t]() }, this), this.options.watchCSS ? this.watchCSS() : this.activate()
    }, p.option = function(t) { n.extend(this.options, t) }, p.activate = function() {
        if (!this.isActive) {
            this.isActive = !0, this.element.classList.add("sliderousel-enabled"), this.options.rightToLeft && this.element.classList.add("sliderousel-rtl"), this.getSize();
        ...
        t.className = "sliderousel-slider", t.style[this.originSide] = 0, this.slider = t
    ...
    return p.setCellAlign = function() {
        ...
        if (this.emitEvent(t, n), l && this.$element) {
            t += this.options.namespaceJQueryEvents ? ".sliderousel" : "";
            var s = t;
            if (e) {
                var o = l.Event(e);
                o.type = t, s = o
    ...
    }, p.getCellElements = function() { return this.cells.map(function(t) { return t.element }) }, p.getParentCell = function(t) { var e = this.getCell(t); return e ? e : (t = n.getParent(t, ".sliderousel-slider > *"), this.getCell(t)) }, p.getAdjacentCellElements = function(t, e) {
        ...
        if (t) {
            ...
            e.indexOf("sliderousel") != -1 ? this.activate() : this.deactivate()
        }
    ...
    }, p.deactivate = function() { this.isActive && (this.element.classList.remove("sliderousel-enabled"), this.element.classList.remove("sliderousel-rtl"), this.cells.forEach(function(t) { t.destroy() }), this.unselectSelectedSlide(), this.element.removeChild(this.viewport), a(this.slider.children, this.element), this.options.accessibility && (this.element.removeAttribute("tabIndex"), this.element.removeEventListener("keydown", this)), this.isActive = !1, this.emitEvent("deactivate")) }, p.destroy = function() { this.deactivate(), t.removeEventListener("resize", this), this.emitEvent("destroy"), l && this.$element && l.removeData(this.element, "sliderousel"), delete this.element.sliderouselGUID, delete f[this.guid] }, n.extend(p, r), h.data = function(t) { t = n.getQueryElement(t); var e = t && t.sliderouselGUID; return e && f[e] }, n.htmlInit(h, "sliderousel"), l && l.bridget && l.bridget("sliderousel", h), h.setJQuery = function(t) { l = t }, h.Cell = s, h
}),
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/drag", ["./sliderousel", "unidragger/unidragger", "fizzy-ui-utils/utils"], function(i, n, s) { return e(t, i, n, s) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./sliderousel"), require("unidragger"), require("fizzy-ui-utils")) : t.sliderousel = e(t, t.sliderousel, t.Unidragger, t.fizzyUIUtils) }(window, function(t, e, i, n) {
    function s(t) {
    ...
    function o() { return { x: t.pageXOffset, y: t.pageYOffset } } n.extend(e.defaults, { draggable: !0, dragThreshold: 3 }), e.createMethods.push("_createDrag");
    var r = e.prototype;
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/prev-next-button", ["./sliderousel", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], function(i, n, s) { return e(t, i, n, s) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./sliderousel"), require("tap-listener"), require("fizzy-ui-utils")) : e(t, t.sliderousel, t.TapListener, t.fizzyUIUtils) }(window, function(t, e, i, n) {
    "use strict";
    ...
    s.prototype = new i, s.prototype._create = function() {
        ...
        e.className = "sliderousel-prev-next-button", e.className += this.isPrevious ? " previous" : " next", e.setAttribute("type", "button"), this.disable(), e.setAttribute("aria-label", this.isPrevious ? "previous" : "next");
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/page-dots", ["./sliderousel", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], function(i, n, s) { return e(t, i, n, s) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./sliderousel"), require("tap-listener"), require("fizzy-ui-utils")) : e(t, t.sliderousel, t.TapListener, t.fizzyUIUtils) }(window, function(t, e, i, n) {
    function s(t) { this.parent = t, this._create() } s.prototype = new i, s.prototype._create = function() { this.holder = document.createElement("ol"), this.holder.className = "sliderousel-page-dots", this.dots = [], this.on("tap", this.onTap), this.on("pointerDown", this.parent.childUIPointerDown.bind(this.parent)) }, s.prototype.activate = function() { this.setDots(), this.bindTap(this.holder), this.parent.element.appendChild(this.holder) }, s.prototype.deactivate = function() { this.parent.element.removeChild(this.holder), i.prototype.destroy.call(this) }, s.prototype.setDots = function() {
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/player", ["ev-emitter/ev-emitter", "fizzy-ui-utils/utils", "./sliderousel"], function(t, i, n) { return e(t, i, n) }) : "object" == typeof module && module.exports ? module.exports = e(require("ev-emitter"), require("fizzy-ui-utils"), require("./sliderousel")) : e(t.EvEmitter, t.fizzyUIUtils, t.sliderousel) }(window, function(t, e, i) {
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/add-remove-cell", ["./sliderousel", "fizzy-ui-utils/utils"], function(i, n) { return e(t, i, n) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./sliderousel"), require("fizzy-ui-utils")) : e(t, t.sliderousel, t.fizzyUIUtils) }(window, function(t, e, i) {
...
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/lazyload", ["./sliderousel", "fizzy-ui-utils/utils"], function(i, n) { return e(t, i, n) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./sliderousel"), require("fizzy-ui-utils")) : e(t, t.sliderousel, t.fizzyUIUtils) }(window, function(t, e, i) {
    "use strict";

    function n(t) { if ("IMG" == t.nodeName && t.getAttribute("data-sliderousel-lazyload")) return [t]; var e = t.querySelectorAll("img[data-sliderousel-lazyload]"); return i.makeArray(e) }

    function s(t, e) { this.img = t, this.sliderousel = e, this.load() } e.createMethods.push("_createLazyload");
    var o = e.prototype;
    ...
    }, s.prototype.handleEvent = i.handleEvent, s.prototype.load = function() { this.img.addEventListener("load", this), this.img.addEventListener("error", this), this.img.src = this.img.getAttribute("data-sliderousel-lazyload"), this.img.removeAttribute("data-sliderousel-lazyload") }, s.prototype.onload = function(t) { this.complete(t, "sliderousel-lazyloaded") }, s.prototype.onerror = function(t) { this.complete(t, "sliderousel-lazyerror") }, s.prototype.complete = function(t, e) {
        this.img.removeEventListener("load", this), this.img.removeEventListener("error", this);
        var i = this.sliderousel.getParentCell(this.img),
            n = i && i.element;
        this.sliderousel.cellSizeChange(n), this.img.classList.add(e), this.sliderousel.dispatchEvent("lazyLoad", t, n)
    }, e.LazyLoader = s, e
}),
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel/js/index", ["./sliderousel", "./drag", "./prev-next-button", "./page-dots", "./player", "./add-remove-cell", "./lazyload"], e) : "object" == typeof module && module.exports && (module.exports = e(require("./sliderousel"), require("./drag"), require("./prev-next-button"), require("./page-dots"), require("./player"), require("./add-remove-cell"), require("./lazyload"))) }(window, function(t) { return t }),
function(t, e) { "function" == typeof define && define.amd ? define("sliderousel-as-nav-for/as-nav-for", ["sliderousel/js/index", "fizzy-ui-utils/utils"], e) : "object" == typeof module && module.exports ? module.exports = e(require("sliderousel"), require("fizzy-ui-utils")) : t.sliderousel = e(t.sliderousel, t.fizzyUIUtils) }(window, function(t, e) {
    function i(t, e, i) { return (e - t) * i + t } t.createMethods.push("_createAsNavFor");
    var n = t.prototype;
...
function(t, e) { "function" == typeof define && define.amd ? define(["sliderousel/js/index", "imagesloaded/imagesloaded"], function(i, n) { return e(t, i, n) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("sliderousel"), require("imagesloaded")) : t.sliderousel = e(t, t.sliderousel, t.imagesLoaded) }(window, function(t, e, i) {
    "use strict";
...
var slider = document.querySelectorAll('.sliderousel.slider');
var carousel = document.querySelectorAll('.sliderousel.carousel');
var bannerSlider = document.querySelectorAll('.sliderousel.bannerSlider');

function sliderouselResize() {
    if (window.innerWidth <= 736) {
        for (var i = 0; i < slider.length; i++) {
            slider[i].style.height = slider[i].offsetWidth * .6 + 'px';
            var imgItem = slider[i].querySelectorAll('img');
            for (var a = 0; a < imgItem.length; a++) {
                imgItem[a].dataset.sliderouselLazyload = imgItem[a].getAttribute("data-mobilesrc");
                imgItem[a].style.height = slider[i].offsetWidth * .6 + 'px';
            }
        }
    } else {
        for (var i = 0; i < slider.length; i++) {
            slider[i].style.height = slider[i].offsetWidth / 3.36 + 'px';
            var imgItem = slider[i].querySelectorAll('img');
            for (var a = 0; a < imgItem.length; a++) {
                imgItem[a].dataset.sliderouselLazyload = imgItem[a].getAttribute("data-src");
                imgItem[a].style.height = slider[i].offsetWidth / 3.36 + 'px';
            }
        }
    }
}
...
var sliders = [];
for (var i = 0; i < slider.length; i++) {
    var sliderEl = new sliderousel(slider[i], {
        autoPlay: 3000,
        initialIndex: 0,
        pageDots: true,
        wrapAround: true,
...
sliders[0].element.addEventListener('mouseleave', function() {
    sliders[0].playPlayer();
});
// }

// var imgs = slider[0].querySelectorAll('.slider img');
// var docStyle = document.documentElement.style;
// var transformProp = typeof docStyle.transform == 'string' ?
//   'transform' : 'WebkitTransform';
// sliders[0].on( 'scroll', function() {
//   sliders[0].slides.forEach( function( slide, i ) {
//     var img = imgs[i];
//     var x = ( slide.target + sliders[0].x ) * -1/3;
//     img.style[ transformProp ] = 'translateX(' + x  + 'px)';
//   });
// });

window.onload = function() {
    $('.slider .heading-content').css({ 'opacity': '1' });
}
window.onresize = function() {
    sliderouselResize();
};
for (var i = 0; i < carousel.length; i++) {
    var carouselEl = new sliderousel(carousel[i], {
        autoPlay: 2000,
        initialIndex: 1,
        pageDots: false,
        wrapAround: true,
    ...
    carousel[i].addEventListener('mouseleave', function() {
        carouselEl.playPlayer();
    });
}

for (var i = 0; i < bannerSlider.length; i++) {
    if (bannerSlider[i].querySelectorAll('.item').length > 1) {
        var bannerSliderlEl = new sliderousel(bannerSlider[i], {
            autoPlay: 3000,
            initialIndex: 1,
            pageDots: false,
            wrapAround: true,
        ...
        // bannerSlider[i].addEventListener('mouseleave', function() {
        //     bannerSliderEl.playPlayer();
        // });
    }
